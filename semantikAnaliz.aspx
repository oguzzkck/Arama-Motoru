<%@ Page Language="C#" AutoEventWireup="true" CodeFile="semantikAnaliz.aspx.cs" Inherits="semantikAnaliz" %>
...
<body id="grad1">
    <form id="form1" runat="server">
        <nav class="nav nav-pills nav-fill">
          ...
          <a class="nav-item nav-link active" href="semantikAnaliz.aspx">Semantik Analiz</a>
        </nav>
        ...
        <div class="sonuc">
            ...
            <asp:ListBox ID="ListBox8" runat="server" Height="115px" Width="363px" SelectionMode="Multiple" AutoPostBack="True" OnSelectedIndexChanged="ListBox8_SelectedIndexChanged"></asp:ListBox>
