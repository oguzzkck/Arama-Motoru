...
<head runat="server">
    ...
    <title>Anahtar Kelime Saydırma</title>
    ...
    <form id="form1" runat="server">
       <%-- <nav>
            <ul class="nav nav-tabs">
                <li role="presentation" class="active"><a href="index.aspx">Anahtar Kelime Saydırma</a></li>
                <li role="presentation"><a href="sayfaSiralama.aspx">Sayfa (URL) Sıralama</a></li>
                <li role="presentation"><a href="siteSiralama.aspx">Site Sıralama</a></li>
                <li role="presentation"><a href="semantikAnaliz.aspx">Semantik Analiz</a></li>
            </ul>
        </nav>--%>
        <nav class="nav nav-pills nav-fill">
          <a class="nav-item nav-link active" href="index.aspx">Anahtar Kelime Saydırma</a>
        ...
        <div class="sonuc">
            ...
            <asp:ListBox ID="ListBox8" runat="server" Height="115px" Width="303px" SelectionMode="Multiple" AutoPostBack="True" OnSelectedIndexChanged="ListBox8_SelectedIndexChanged"></asp:ListBox>
