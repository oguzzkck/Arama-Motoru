<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sayfaSiralama.aspx.cs" Inherits="sayfaSiralama" %>
...
<body id="grad1">
    <form id="form1" runat="server">
        <nav class="nav nav-pills nav-fill">
          ...
          <a class="nav-item nav-link active" href="sayfaSiralama.aspx">Sayfa (URL) Sıralama</a>
          <a class="nav-item nav-link" href="siteSiralama.aspx">Site Sıralama</a>
        ...
        <div class="sonuc">
            <asp:ListBox ID="ListBox6" runat="server" Height="115px" Width="152px" SelectionMode="Multiple"></asp:ListBox>
            <asp:ListBox ID="ListBox7" runat="server" Height="115px" Width="152px" SelectionMode="Multiple"></asp:ListBox>
            <asp:ListBox ID="ListBox8" runat="server" Height="115px" Width="386px" SelectionMode="Multiple"></asp:ListBox>
            

            <asp:ListBox ID="ListBox1" runat="server" Height="115px" Width="152px" Visible="False"></asp:ListBox>
            ...
            <asp:ListBox ID="ListBox4" runat="server" Height="115px" Width="535px" SelectionMode="Multiple"></asp:ListBox>
            <asp:ListBox ID="ListBox5" runat="server" Height="115px" Width="152px" SelectionMode="Multiple"></asp:ListBox>
